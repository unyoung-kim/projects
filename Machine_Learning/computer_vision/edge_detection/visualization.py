...
# image = cv.imread('data/148089_noisy.png')
# imgA = cv.bilateralFilter(image, d= 1, sigmaColor = 25.5, sigmaSpace = 1.0)
# imgB = cv.bilateralFilter(image, d= 3,sigmaColor = 25.5, sigmaSpace = 3.0)
...
## Problem 4 - Sobel gradient operator (5 Points)
##
...
# Problem 5 -  (a) Nonmax suppression (10 Points)
